...
public interface InterfaceCtrlManterDepartamentos {
	@POST
	@Path("login/{conta}")
	@Produces(MediaType.TEXT_PLAIN)
	public String login(@PathParam("conta") String conta) throws Exception;

	@POST
	@Path("incluirDepartamento")
